...
/**
 * Editable PMI-CP page — full granular. Icons/colors/gradients and the track
 * number badges stay in code; all text, lists, cards, pricing and the FAQ are
 * editable. The eligibility callout has an optional rich-text override; empty =
 * the page's exact built-in markup.
 */
        ...
        },
        {
          ...
          fields: [
            ...
            { name: "eligibilityIntro", type: "textarea" },
            {
              name: "tracks",
              type: "array",
              label: "Eligibility tracks",
              admin: { description: "2 tracks. The numbered badge is fixed in code." },
              fields: [
                { name: "title", type: "text", required: true },
