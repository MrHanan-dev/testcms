...
/** Original Consulting page content — single source for page fallbacks and seed-consulting. */
export const CONSULTING_CONTENT = {
  ...
  faqTitle: "Consulting FAQs",
  faqSubtitle: "Expert Advisory",
  faqDescription: "Clear answers about our project management consulting and recovery services.",
  faqItems: globalFaqs.consulting,
};
