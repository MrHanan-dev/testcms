/** Original Contract Management page content — single source for page fallbacks and seed-contract. */
export const CONTRACT_CONTENT = {
  heroTitle: "Construction Contracts",
  heroDescription:
    "Expert contract management, formulation, and dispute resolution. We safeguard your commercial interests through rigorous administration and strategic advisory.",
