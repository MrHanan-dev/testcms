    ...
    const mainServices = [
        {
            ...
            desc: "TotalQS is your one-stop solution for quantity takeoff services and construction consultation. We provide a complete range of services including quantity takeoff, scheduling, and project execution support. Quantity takeoff is an important process in construction that helps planners and engineers accurately estimate the materials required for a project.",
            image: "/images/pmbok_evolution.jpeg",
            icon: FileText
        },
        {
            title: "Preliminary Estimate",
            desc: "Looking for an Estimate on Your Construction Project? Look no further than TotalQS. Our consultants provide accurate preliminary estimates so you can be confident you are getting the best possible value for your project. We deliver precise estimates that help you save both time and money.",
        ...
        },
        {
            ...
            desc: "Looking for a reliable and quality driven construction contractor? TotalQS has you covered. We offer comprehensive tendering services to ensure you get the best value for your investment. We transform design concepts into detailed bid documents and facilitate subcontractor interviews.",
