...
export default function FinalCTA({
    headingLead = "Ready to Elevate Your",
    headingAccent = "Project Strategy?",
    paragraph = "Join over 5,000 professionals who have transformed their careers and organizations with our elite training and consultancy.",
                ...
                <div className="max-w-5xl mx-auto bg-slate-50 rounded-[40px] md:rounded-[64px] p-8 md:p-24 text-center relative overflow-hidden border border-slate-100 shadow-xl">
                    ...
                    >
                        <h2 className="text-[clamp(32px,6vw,72px)] font-black text-primary leading-[0.95] tracking-tight mb-10">
                            {headingLead} <br />
                            <span className="text-accent italic font-serif">{headingAccent}</span>
                        </h2>
